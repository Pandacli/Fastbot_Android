...
cmake -DCMAKE_TOOLCHAIN_FILE=G:/software/AndroidSdk/ndk/25.2.9519653/build/cmake/android.toolchain.cmake -DANDROID_ABI=x86 -DCMAKE_BUILD_TYPE=Release
make
